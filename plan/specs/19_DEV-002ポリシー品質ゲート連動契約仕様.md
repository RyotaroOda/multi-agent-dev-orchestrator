...
| --- | --- | --- | --- |
| `skip/only` 記法追加 | `blocked` | `policy:allow-test-change` が有効 | `violation_type`, `approver`, `expiry_date` |
| テスト削除・大幅減少 | `blocked` | `policy:allow-test-change` が有効 | `affected_files`, `assertion_delta` |
